...
--
-- Table structure for table `foirfjor`
--

DROP TABLE IF EXISTS `foirfjor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `foirfjor` (
  `id` bigint NOT NULL,
...
--
-- Dumping data for table `foirfjor`
--

LOCK TABLES `foirfjor` WRITE;
/*!40000 ALTER TABLE `foirfjor` DISABLE KEYS */;
/*!40000 ALTER TABLE `foirfjor` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `foirfjor_seq`
--

DROP TABLE IF EXISTS `foirfjor_seq`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `foirfjor_seq` (
  `next_val` bigint DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `foirfjor_seq`
--

LOCK TABLES `foirfjor_seq` WRITE;
/*!40000 ALTER TABLE `foirfjor_seq` DISABLE KEYS */;
INSERT INTO `foirfjor_seq` VALUES (1);
/*!40000 ALTER TABLE `foirfjor_seq` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `modelos_seq` VALUES (101);
...
-- Dump completed on 2024-04-25 23:06:08
